    ...
    <nav className="fixed top-0 font-serif px-12 text-lg dark:text-black py-5 pt-10 left-0 right-0 bg-white transition-all duration-300 flex justify-between items-center z-50">
      ...
      <div className="hidden md:flex bg-white items-center gap-8">
        <Link
          ...
          className={`hover:underline hover:text-gray-500 ${
            isActive("/Work") ? "text-cyan-700 underline underline-offset-4 font-bold" : "text-black"
          }`}
        >
          Work
        </Link>
        <Link
          href="/About"
          className={`hover:underline hover:text-gray-500 ${
            isActive("/About") ? "text-cyan-700 underline underline-offset-4 font-bold" : "text-black"
          }`}
        >
          About
        </Link>
        <Link
          href="/Service"
          className={`hover:underline hover:text-gray-500 ${
            isActive("/Service") ? "text-cyan-700 underline underline-offset-4 font-bold" : "text-black"
          }`}
        >
          Our Services
        </Link>
        <div className="relative group">
          <button className="hover:underline hover:text-gray-500  text-black gap-2" >
          ...
          <div className="absolute bg-white right-[50%] mt-5 pt-5 w-60 opacity-0 invisible group-hover:opacity-100 group-hover:visible group-hover:top-0 group-hover:right-0 transition-all duration-300 gap-4">
            <Link
              href="/Residential"
              className={`block ml-22 hover:bg-gray-200 ${
                isActive("/Residential") ? "text-cyan-700 font-bold" : "text-black"
              }`}
            >
              Residential Design
            </Link>
            <Link
              href="/Commercial"
              className={`block ml-20 hover:bg-gray-200 ${
                isActive("/Commercial") ? "text-cyan-700 font-bold" : "text-black"
              }`}
            >
              Commercial Design
            </Link>
            <Link
              href="/Experiential"
              className={`block ml-20 hover:bg-gray-200 ${
                isActive("/Experiential") ? "text-cyan-700 font-bold" : "text-black"
              }`}
            >
              Experiential Design
            </Link>
      ...
      >
        ...
        <Link
          href="/Sous-Menu"
          className={`hover:underline hover:text-gray-500 ${
            isActive("/Projects") ? "text-cyan-700 underline underline-offset-4 font-bold" : "text-black"
          }`}
          onClick={() => setIsOpen(false)}
        >
          Projects
