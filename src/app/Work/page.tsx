    ...
    <div className="md:px-8  py-25 justify-center items-center text-black">  
      ...
      <div className="pt-20  grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="justify-between px-10">
          ...
          <p className="pt-10 font-arial">
          Apartments, homes and vacation properties.
          </p>
        </div>
        <div className="justify-end px-6 flex">
          <Link href="Residential" className="rounded-lg bg-black hover:bg-gray-400  text-white py-6 px-20">
            See Project
          </Link>
        </div>
      </div>
      ...
      <div className="pt-20  grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="justify-end px-6 flex">
          <Link href="Commercial" className="rounded-lg bg-black hover:bg-gray-400  text-white py-6 px-20">
            See Project
          </Link>
        </div>
      </div>
      ...
      <div className="pt-20  grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="justify-end px-6 flex">
          <Link href="Experiential" className="rounded-lg bg-black hover:bg-gray-400  text-white py-6 px-20">
            See Project
          </Link>
        </div>
      </div>
